...
export declare function useWatch<T>(watcher: Watcher<T>): T;
export declare function useWatch<T>(cache: Cache<T>): T;
export declare function useWatch<T>(state: State<T>): T;
